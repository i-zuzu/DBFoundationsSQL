...
-- 2023-05-22,IZubova,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_IZubova')
	 Begin 
	  Alter Database [Assignment06DB_IZubova] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_IZubova;
	 End
	Create Database Assignment06DB_IZubova;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_IZubova;
...
GO
--Creating View for Products table
...
--Creating View for Inventories table
...
--Select Query from Assignment 5
...
--SELECT Query from Assignment 5
SELECT DISTINCT Inventories.InventoryDate, Employees.EmployeeFirstName + ' ' + Employees.EmployeeLastName AS EmployeeName
...
AS
  ...
  vInventories.InventoryDate, vEmployees.EmployeeFirstName + ' ' + vEmployees.EmployeeLastName AS EmployeeName
...
--SELECT Query from Asssignment 5
SELECT 
